...
class Nexys4DDRMIGIODDR(depth : BigInt) extends Bundle {
  require((depth<=0x08000000L),"Nexys4DDRMIGIODDR supports upto 128 MB depth configuraton")
...
{
  require((depth<=0x08000000L),"nexys4ddrmig supports upto 128 MB depth configuraton")
  ...
  val io = new Nexys4DDRMIGIODDR(depth) with Nexys4DDRMIGIOClocksReset {
    ...
    val s_axi_awaddr          = Input(Bits(27.W))
    ...
    val s_axi_araddr          = Input(Bits(27.W))
